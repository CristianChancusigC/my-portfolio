...
// const linkCVEn = "https://cristianchancusigc.github.io/my-portfolio/cv/Cristian_Chancusig_CV.pdf";
  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div
          className={`${styles.paddingX} col-span-7 place-self-center text-center sm:text-left mt-5`}
        >
          <h1 className="text-slate-600 mb-4 mt-20 text-4xl sm:text-5xl lg:text-6xl font-extrabold dark:text-white">
          ...
          <p className="text-text-description-light text-lg mb-6 lg:text-xl dark:text-text-description-dark">
            {t("Hero.intro")}
          </p>
          <div>
            <a
            ...
            <button
              ...
              dark:bg-gradient-to-br dark:from-blue-500 dark:via-primary-500 dark:to-secondary-500 dark:hover:bg-slate-500 dark:text-white"
            >
              <a
                href={linkCVEn}
                download
              ...
              >
                <span className="block bg-background-light hover:bg-btn-hover-light rounded-full px-5 py-2 dark:bg-background-dark dark:hover:bg-btn-hover-dark">
                  {t("Hero.download")}
                </span>
              </a>
            </button>
